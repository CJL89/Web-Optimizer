...
var resizePizzas = function(size) {
  ...
  changeSliderLabel(size);
    ...
    // newWidth was added in so it is not calculated every time when it was in percentile format.
...
// Variable pizzasDiv was moved outside the for loop to limit output.
